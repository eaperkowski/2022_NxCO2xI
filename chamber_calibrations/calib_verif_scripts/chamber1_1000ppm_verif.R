...
###############################################################################
licor <- licorData("../calib_verif_files/c1_1000ppm_calib_verif_licor") %>%
...
chamber1 <- read.csv("../calib_verif_files/c1_1000ppm_calib_verif.csv") %>%
...
temp <- ggplot() +
  ...
  scale_color_manual(values = c("red", "blue", "black"),
                     labels = c("Licor",
                                "Chamber sensor", 
                                "Chamber set point")) +
  scale_x_datetime(limits = c(as.POSIXct("2022-06-06 11:00"),
                              as.POSIXct("2022-06-06 15:30")),
                   breaks = c(as.POSIXct("2022-06-06 11:00"),
                              as.POSIXct("2022-06-06 11:45"),
                              as.POSIXct("2022-06-06 12:30"),
                              as.POSIXct("2022-06-06 13:15"),
                              as.POSIXct("2022-06-06 14:00"),
                              as.POSIXct("2022-06-06 14:45"),
                              as.POSIXct("2022-06-06 15:30")),
                   date_labels = "%R") +
