...
###############################################################################
licor <- licorData("../calib_verif_files/c2_1000ppm_calib_verif_licor2") %>%
...
chamber2 <- read.csv("../calib_verif_files/c2_1000ppm_calib_verif2.csv") %>%
...
li.25C <- subset(licor, date < "2022-06-10 14:30:00")
ch2.25C <- subset(chamber2, date < "2022-06-10 14:30:00")
...
###############################################################################
# Subset Licor and chamber measurements that were set at 25degC
li.17C <- subset(licor, date > "2022-06-10 15:30:00" & date < "2022-06-10 16:30:00")
ch2.17C <- subset(chamber2, date > "2022-06-10 15:30:00" & date < "2022-06-10 16:30:00")
