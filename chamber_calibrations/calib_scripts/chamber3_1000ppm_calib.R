...
# Chamber 2 day CO2 offset: XX ppm CO2
...
ch3.25C <- subset(chamber3, date < "2022-06-02 10:45:00")
...
ch3.21C <- subset(chamber3, date > "2022-06-02 11:20:00" & date < "2022-06-02 11:50:00")
...
ch3.17C <- subset(chamber3, date > "2022-06-02 12:45:00" & date < "2022-06-02 13:30:00")
